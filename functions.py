...
def show_go_screen():
    ...
    draw_text(screen, u"BAJKI ROBOTÓW", 84, WIDTH / 2, HEIGHT / 4)
    draw_text(screen, u"Strzałki sterują robotem a spacja to atak", 42, WIDTH / 2, HEIGHT / 2)
    draw_text(screen, u"Naciśnij dowolny klawisz żeby zacząć grę", 28, WIDTH / 2, HEIGHT * 3 / 4)
    draw_text(screen, u"Dojdź do krzyża", 28, WIDTH/2 , HEIGHT*4 / 5)
